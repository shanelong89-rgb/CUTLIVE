...
// Real CULTIVE events (populated from database)
export const mockEvents: Event[] = [
  {
    ...
    category: 'Music',
    price: '$200',
    description: 'Join us for a weekend of cutting-edge techno featuring international DJs. Two rooms of non-stop beats in the heart of Wan Chai.',
    isExclusive: true,
    is_exclusive: true,
    district: 'Wan Chai',
  },
  {
    ...
    category: 'Music',
    price: '$250',
    description: 'An intimate underground club experience featuring French house and disco. Limited capacity - members get priority entry.',
    isExclusive: true,
    is_exclusive: true,
    district: 'Central',
  },
  {
    ...
    category: 'Music',
    price: 'Free',
    description: 'Weekly jazz sessions featuring local Hong Kong musicians. Craft cocktails and intimate setting perfect for mid-week unwinding.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Central',
  },
  {
    ...
    category: 'Music',
    price: '$150',
    description: 'Live electronic music showcase featuring modular synthesizers and ambient soundscapes. Rooftop vibes with harbor views.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Tai Hang',
  },
  {
    ...
    category: 'Nightlife',
    price: '$180',
    description: 'Underground deep house vibes in one of Hong Kong\'s most intimate venues. Resident DJs and surprise guests weekly.',
    isExclusive: true,
    is_exclusive: true,
    district: 'Central',
  },
  {
    ...
    category: 'Nightlife',
    price: '$220',
    description: 'High-energy techno night featuring international and local DJs. State-of-the-art sound system and immersive lighting.',
    isExclusive: true,
    is_exclusive: true,
  ...
  },
  {
    ...
    category: 'Music',
    price: '$180',
    description: 'Support local indie bands at Mong Kok\'s premier live music venue. Three bands, one unforgettable night.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Mong Kok',
  },
  {
    ...
    category: 'Nightlife',
    price: '$150',
    description: 'Salsa, bachata, and reggaeton all night long. Beginner-friendly with complimentary dance lesson at 9pm.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Central',
  },
  {
    ...
    category: 'Food',
    price: 'Free entry',
    description: 'Rooftop cocktails and live acoustic music as the sun sets over Victoria Harbour. Happy hour until 7pm.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Central',
  },
  {
    ...
    category: 'Nightlife',
    price: '$300',
    description: 'Members-only access to Hong Kong\'s most exclusive speakeasy. Craft cocktails and intimate jazz performances.',
    isExclusive: true,
    is_exclusive: true,
    district: 'Central',
  },
  {
    ...
    category: 'Arts',
    price: '$200',
    description: 'Learn spray paint techniques from local graffiti artists. Create your own piece on our legal wall. All materials provided.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Sheung Wan',
  },
  {
    ...
    category: 'Wellness',
    price: '$100',
    description: 'Morning yoga with panoramic harbour views. Suitable for all levels. Mats and refreshments included.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Central',
  },
  {
    ...
    category: 'Nightlife',
    price: '$50',
    description: 'Connect with Hong Kong\'s creative professionals over curated cocktails. Members get first drink complimentary.',
    isExclusive: true,
    is_exclusive: true,
    district: 'Admiralty',
  },
  {
    ...
    category: 'Arts',
    price: '$120',
    description: 'Stand-up comedy featuring Hong Kong\'s funniest English-speaking comedians. Two drink minimum.',
    isExclusive: false,
    is_exclusive: false,
    district: 'Sheung Wan',
  },
...
export const categories = ['All', ...CANONICAL_CATEGORIES.map(id => CATEGORY_LABELS[id]), 'Exclusive'];

export const AVAILABLE_TAGS = CANONICAL_CATEGORIES.map(id => ({ id, label: CATEGORY_LABELS[id] }));
